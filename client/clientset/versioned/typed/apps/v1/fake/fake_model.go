...
func (c *FakeModels) Get(name string, options v1.GetOptions) (result *appsv1.Model, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(modelsResource, name), &appsv1.Model{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeModels) List(opts v1.ListOptions) (result *appsv1.ModelList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(modelsResource, modelsKind, opts), &appsv1.ModelList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeModels) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(modelsResource, opts))
}
...
func (c *FakeModels) Create(model *appsv1.Model) (result *appsv1.Model, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(modelsResource, model), &appsv1.Model{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Model), err
...
func (c *FakeModels) Update(model *appsv1.Model) (result *appsv1.Model, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(modelsResource, model), &appsv1.Model{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Model), err
...
func (c *FakeModels) UpdateStatus(model *appsv1.Model) (*appsv1.Model, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(modelsResource, "status", model), &appsv1.Model{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Model), err
...
func (c *FakeModels) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(modelsResource, name), &appsv1.Model{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeModels) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(modelsResource, listOptions)
...
func (c *FakeModels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *appsv1.Model, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(modelsResource, name, data, subresources...), &appsv1.Model{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Model), err
